...
class utf_normalizer
{
	...
	*/
	static function cleanup(&$str)
	{
		...
		if (!isset($GLOBALS['utf_nfc_qc']))
		{
			...
			include($mangareader_root_path . 'includes/utf/data/utf_nfc_qc.php');
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			global $mangareader_root_path;
			include($mangareader_root_path . 'includes/utf/data/utf_canonical_decomp.php');
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		{
			global $mangareader_root_path;
			include($mangareader_root_path . 'includes/utf/data/utf_normalizer_common.php');
		}
		...
		{
			global $mangareader_root_path;
			include($mangareader_root_path . 'includes/utf/data/utf_canonical_comp.php');
		}
